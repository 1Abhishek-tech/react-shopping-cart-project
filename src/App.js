    ...
    return (
      <div className="App">
        ...
        <div className="filter">
          ...
          <button onClick={this.L2Hfilter}>low to high</button>
          <button onClick={this.H2Lfilter}> high to low</button>
        </div>
        ...
        <div className="total">Amount to be Paid :{this.getCartTotal()} Rs</div>
      </div>
    );
  }
}
